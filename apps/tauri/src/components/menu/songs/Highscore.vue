...
<template>
  <div
    class="flex flex-col gap-0.6cqw"
    :class="[!highscores || highscores.length === 0 ? 'opacity-0' : 'transition-opacity duration-300']"
  >
    <div
    ...
    >
      <div
        class="w-2.5cqw pl-0.2cqw text-center bg-white/80 text-black font-semibold flex items-center justify-center"
