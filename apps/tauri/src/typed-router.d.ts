...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    '/lobby/[id]': RouteRecordInfo<'/lobby/[id]', '/lobby/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/party/': RouteRecordInfo<'/party/', '/party', Record<never, never>, Record<never, never>>,
    '/party/versus/': RouteRecordInfo<'/party/versus/', '/party/versus', Record<never, never>, Record<never, never>>,
    '/party/versus/settings': RouteRecordInfo<'/party/versus/settings', '/party/versus/settings', Record<never, never>, Record<never, never>>,
    '/round/score': RouteRecordInfo<'/round/score', '/round/score', Record<never, never>, Record<never, never>>,
    '/round/selection': RouteRecordInfo<'/round/selection', '/round/selection', Record<never, never>, Record<never, never>>,
    '/round/sing': RouteRecordInfo<'/round/sing', '/round/sing', Record<never, never>, Record<never, never>>,
